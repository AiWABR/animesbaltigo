...
VIDEO_DOWNLOAD_CHUNK_MB = int(os.getenv("VIDEO_DOWNLOAD_CHUNK_MB", "8"))
VIDEO_DOWNLOAD_PART_MB = int(os.getenv("VIDEO_DOWNLOAD_PART_MB", "16"))
VIDEO_DOWNLOAD_PARALLEL = os.getenv("VIDEO_DOWNLOAD_PARALLEL", "1").strip().lower() in {"1", "true", "yes", "on", "sim"}
VIDEO_DOWNLOAD_PARALLEL_WORKERS = int(os.getenv("VIDEO_DOWNLOAD_PARALLEL_WORKERS", "6"))
