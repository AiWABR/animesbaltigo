...
VIDEO_CACHE_TTL_HOURS = int(os.getenv("VIDEO_CACHE_TTL_HOURS", "3"))
VIDEO_CACHE_CLEANUP_INTERVAL_SECONDS = int(os.getenv("VIDEO_CACHE_CLEANUP_INTERVAL_SECONDS", "1800"))
