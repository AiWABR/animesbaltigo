...
CONTROL_AGENT_PORT = int(os.getenv("CONTROL_AGENT_PORT", "8781"))
CONTROL_BOT_ID = os.getenv("CONTROL_BOT_ID", "animes").strip() or "animes"
CONTROL_BOT_NAME = os.getenv("CONTROL_BOT_NAME", "AnimesBaltigo_Bot").strip() or CONTROL_BOT_ID
